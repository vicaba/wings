...
/**
  ...
  */
@Singleton
class ListVirtualObjectSensedController
 extends Controller {

  val listVirtualObjectSensedUseCase: ListVirtualObjectSensed.UseCase = inject[ListVirtualObjectSensed.UseCase](identified by 'ListVirtualObjectSensedUseCase)
