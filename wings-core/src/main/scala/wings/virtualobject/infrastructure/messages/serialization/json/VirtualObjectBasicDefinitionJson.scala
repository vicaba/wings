...
import wings.virtualobject.domain.messages.command.VirtualObjectBasicDefinition
import wings.virtualobject.infrastructure.messages.keys.VirtualObjectBasicDefinitionKeys
