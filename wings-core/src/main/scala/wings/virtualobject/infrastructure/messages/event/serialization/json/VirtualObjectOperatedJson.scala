package wings.virtualobject.infrastructure.messages.event.serialization.json
...
import wings.virtualobject.domain.messages.event.{VirtualObjectActuated, VirtualObjectSensed}
