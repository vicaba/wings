package wings.virtualobject.infrastructure.messages.event.repository.mongodb
...
import wings.virtualobject.infrastructure.messages.event.serialization.json.VirtualObjectOperatedJson
