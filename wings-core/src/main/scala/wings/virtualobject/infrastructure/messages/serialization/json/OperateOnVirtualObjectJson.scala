package wings.virtualobject.infrastructure.messages.serialization.json

import play.api.libs.functional.syntax._
import play.api.libs.json.Reads._
import play.api.libs.json.{OWrites, Reads, _}
import wings.virtualobject.domain.messages.command.{ActuateOnVirtualObject, WatchVirtualObject}
import wings.virtualobject.infrastructure.messages.keys.OperateOnVirtualObjectKeys
